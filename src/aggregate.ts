 ...
 *
 * @param oldVal older (left) data point
 * @param newVal newer (right) data point
 */
 ...
 * @param index index of the bucket this data point belongs to
 * @param options aggregation state
 */
 ...
 *
 * @param workDP data points of one time period, sorted ascending by timestamp
 */
 ...
 *
 * @param options aggregation state with the already calculated `result`
 */
